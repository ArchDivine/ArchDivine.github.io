...
$(document).ready(() => {
    const links = [{
            name: 'izzypuppycat',
            link: '2243771341/profile',
        },
        {
            name: 'KILLA_Bright',
            link: '2382911094/profile',
        },
        {
            name: 'OFcolab',
            link: '3915080524/profile',
        },
        {
            name: 'OFproducer',
            link: '3915078904/profile',
        },
        {
            name: 'wSentinal',
            link: '3890285218/profile',
        },
    ];
    ...
    app.titleChanger(['divine', 'trashtalker', 'we up fr']);
...
$.getJSON(ipgeolocation, (data) => {
    writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[divine]</span>..."], 30, () => {
        ...
        writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
            ...
            writeLine([`<i style='color: #EE4B2B'>created by divine</i>`], 120, 500, () => {
                timeouts.push(
                    setTimeout(() => {
                        if (app.skippedIntro) return;
